...
export const Product=({route, navigation})=>{
    ...
    // const [url, setUrl] = useState('https://fakestoreapi.com/products/category')

    // {()=>setUrl(`https://fakestoreapi.com/products/category/${itemName}`)}
                    ...
                    renderItem={({ item }) => (
                        ...
                        <Pressable
                          ...
                          <View style={styles.productItems}>
                              ...
                              {/* <Text style={styles.productItem}>{item.split(' ').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ')}</Text> */}
                          </View>
                        </Pressable>
